"""
main.py — Streamlit multipage entry point for APP4.0.

Data lives in a local SQLite database (database/analytics.db), initialised
on startup by database/db.py.
"""
import sys
...
st.markdown(
    ...
    "Input Hub · Game Tracker · Rankings · Players · "
    "Team Analytics · Officials · Schedule · Settings."
)
